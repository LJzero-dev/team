...
String ql_title = "", ql_content = "", ql_isview = "", ql_qdate = "", mi_id = "";
int mi_idx = 0;

try {
	stmt = conn.createStatement();
	sql = "select a.ql_idx, b.ai_idx, c.mi_idx, c.mi_id, a.ql_title, a.ql_qdate, a.ql_adate, a.ql_isanswer" + 
			" from t_qna_list a inner join t_admin_info b on a.ai_idx = b.ai_idx " + 
			" inner join t_member_info c on a.mi_id = c.mi_id";
	rs = stmt.executeQuery(sql);
	out.println();
	if (rs.next()) {
		ql_content = rs.getString("nl_content").replace("\r\n", "<br>");
