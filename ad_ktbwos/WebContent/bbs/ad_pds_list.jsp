	...
	<table width="1100" border="0" cellpadding="0" cellspacing="0" id="list">
		...
		if (rs.next()) {
			...
			do {
				...
				title = "<a href='ad_pds_view.jsp?&cpage=" + cpage + "&idx=" + rs.getInt("pl_idx") + schargs + "'>" + title + "</a>" + reply;
	...
	<table style="width:1100px; border:0;">
		<tr>
			...
			<td width="*" style="text-align:right; border:0;">
				<input type="button" value="글등록" style="background-color: white; border: 1px solid black; border-radius: 1px; cursor: pointer;" onclick="location.href='ad_pds_form.jsp?kind=in';" />
			</td>
		</tr>
	</table>
</div>
