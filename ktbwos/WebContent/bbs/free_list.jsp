...
try {
	...
	sql = "select fl_idx, fl_ismem, fl_writer, fl_reply, fl_title, fl_read, if(curdate() = date(fl_date), time(fl_date), replace(mid(fl_date, 3, 8), '-', '.')) fldate from t_free_list" + where + 
