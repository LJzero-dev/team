...
String ql_title = "", ql_content = "", ql_isview = "", ql_qdate = "", mi_id = "", ql_adate = "", ai_id = "";
int mi_idx = 0;


try {
	stmt = conn.createStatement();
	sql = "select b.mi_idx, b.mi_id, a.ql_title, a.ql_content, a.ql_qdate, a.ql_isview " +  
...
<div style="width:1100px; margin:0 auto;">
	...
	<!--  <div id="box"> -->
		...
		<input type="button" name="ql_answer" style="background-color: white; height : 150; border: 1px solid black; border-radius: 1px; cursor: pointer;" value="답변등록" />
		</div>
