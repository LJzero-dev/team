...
<th width="10%" style="background-color: #d3d3d3;">작성자</th><th width="12%" style="background-color: #d3d3d3;">작성일</th>
<th width="15%" style="background-color: #d3d3d3;">답변여부</th>
</tr>
...
if (rs.next()) {
	...
	do {
		...
		title2 = "<a href='ad_qna_view.jsp?idx=" + rs.getInt("ql_idx") + "&cpage=" + cpage + schargs + "'";
