...
String action = "free_form.jsp";	// 수정 시 이동할 파일
if (kind.equals("del")) action = "free_proc_del.jsp";	// 삭제 시 이동할 파일

// 현재 비밀번호를 입력받을 게시글이 비회원 글이 맞는지 검사하는 영역
try {
...
<div id="box">
	<p>비밀번호를 입력하세요.</p>
	<input type="password" name="fl_pw" style="margin-bottom:10px;" />
