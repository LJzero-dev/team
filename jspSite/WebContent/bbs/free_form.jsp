...
if (kind.equals("in")){
if (isLogin) { %>
<th width="15%">작성자</th><td width="35%"><%=loginInfo.getMi_id() %></td>
...
<tr><th>글제목</th><td colspan="3">	<input type="text" name="fl_title" size="60" value="<%=fl_title %>" /></td></tr>
<tr><th>글내용</th><td colspan="3">	<textarea name="fl_content" cols="65" rows="10"><%=fl_content %></textarea></td></tr>
<tr><td colspan="4" align="center">
	<input type="submit" value="글<%=caption %>" />&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="reset" value="다시 입력" />&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="button" value="글목록" onclick="location.href='free_list.jsp?cpage=<%=cpage + args %>';" />
</td></tr>
</table>
</form>
